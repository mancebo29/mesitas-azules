const results = {
  "men": [
    { "name": "César Rondón", "women": 21, "total": 60, "men": 39 },
    { "name": "*No Existe*", "women": 30, "total": 34, "men": 4 },
    ...
    { "name": "Gabriel Abreu (AKA: Heladito)", "women": 37, "total": 73, "men": 36 },
    { "name": "Jairo Mancebo", "women": 65, "total": 212, "men": 147 },
    ...
    { "name": "Diego Torres", "women": 0, "total": 40, "men": 40 },
  ...
  "women": [
    ...
    { "name": "Lía Pérez (AKA Gabby)", "total": 147, "men": 104, "women": 43 },
    { "name": "Ivette Guerrero", "total": 173, "men": 107, "women": 66 },
    { "name": "Charlotte Galviz", "total": 159, "men": 126, "women": 33 },
    ...
    { "name": "Daniella Lapax", "total": 72, "men": 31, "women": 41 },
    { "name": "Lisbeth Matos", "total": 17, "men": 17, "women": 0 },
    { "name": "Luz González", "total": 161, "men": 114, "women": 47 }
  ]
};
...
var winnerEntry = document.querySelector('.winner-entry');
const template = winnerEntry.innerHTML;
winnerEntry.innerHTML = winnerEntry.innerHTML.replace(/\$\{(\w+)\}/g, (match, g1) => {
  switch (g1) {
    case 'name':
      return
  }
